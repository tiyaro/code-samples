package ai.tiyaro.samples.audio_classification;
...
/** Sample code to run audio classification on a local audio file*/
public class LocalAudioInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/huggingface/1/ehcalabres/wav2vec2-lg-xlsr-en-speech-emotion-recognition";
