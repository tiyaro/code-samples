package ai.tiyaro.samples.gcp_classes.gcp_detect_web_geo;
...
/** Sample code to run gcp detect web geo with image url as input */
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_web_geo";
    // Input image
    var imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/sydney_operahouse.jpg";
