package ai.tiyaro.samples.gcp_classes.gcp_detect_properties;
...
// Sample code to run gcp color detection with image url as input
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_properties";
    // Input image
    var imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/grocery_aisle.jpg";
