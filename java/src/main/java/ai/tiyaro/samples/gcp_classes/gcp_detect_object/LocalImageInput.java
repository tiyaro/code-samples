package ai.tiyaro.samples.gcp_classes.gcp_detect_object;
...
// Sample code to run gcp object detection with local image as input
public class LocalImageInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_object";
