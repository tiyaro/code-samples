package ai.tiyaro.samples.gcp_classes.gcp_detect_logos;
...
/** Sample code to run gcp detect logos hints with image url as input */
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_logos";
    // Input image
    var imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/toyota_logo.jpg";
