package ai.tiyaro.samples.gcp_classes.gcp_detect_faces;
...
/** Sample code to run gcp detect faces hints with image url as input */
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_faces";
    // Input image
