package ai.tiyaro.samples.named_entity_recognition;
...
public class NLP {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/huggingface/1/xlm-roberta-large-finetuned-conll03-english";
    // Input
    var inputString =
        "Brady just launched his performance and tech-focused golf \n"
