package ai.tiyaro.samples.recognition_classes.recognition_detect_labels;
...
/** Sample code to run rekognition detect labels (image classification) api with image url as input*/
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/aws/1/rekognition_detect_labels";
    // Input image
    var imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/campus2.jpg";
