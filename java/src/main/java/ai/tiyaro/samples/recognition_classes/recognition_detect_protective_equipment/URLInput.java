package ai.tiyaro.samples.recognition_classes.recognition_detect_protective_equipment;
...
// Sample code to run rekognition detect protective equipment with image url as input
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/aws/1/rekognition_detect_protective_equipment";
    // Input image
    var imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/bicycle_helmet.jpg";

    var client = HttpClient.newHttpClient();

    var payload = new JSONObject();
    payload.put("Image", Collections.singletonMap("URL", imgURL));
