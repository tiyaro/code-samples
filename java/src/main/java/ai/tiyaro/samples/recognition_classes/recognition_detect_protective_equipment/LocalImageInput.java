...
/** Sample code to run rekognition detect protective equipment with local image as input*/
public class LocalImageInput {
  ...
  public void infer() throws Exception {
    ...
    var imgPath = "testdata/bicycle_helmet.jpg";
    var b64Img = imageToBase64(imgPath);

    var client = HttpClient.newHttpClient();

    var payload = new JSONObject();
    payload.put("Image", Collections.singletonMap("Bytes", b64Img));
