...
/** Sample code to run rekognition compare faces api with image url as input*/
public class URLInput {
  ...
  public void infer() throws Exception {
    ...
    // Input image
    var img1URL = "http://starschanges.com/wp-content/uploads/2015/10/Tom-Brady_1-847x1024.jpg";
    var img2URL = "http://starschanges.com/wp-content/uploads/2015/10/Tom-Brady_9.jpg";

    var client = HttpClient.newHttpClient();

    var payload = new JSONObject();
    payload.put("SourceImage", Collections.singletonMap("URL", img1URL));
    payload.put("TargetImage", Collections.singletonMap("URL", img2URL));
