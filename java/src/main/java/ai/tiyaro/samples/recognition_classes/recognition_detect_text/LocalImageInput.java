package ai.tiyaro.samples.recognition_classes.recognition_detect_text;
...
/** Sample code to run rekognition detect text detection with local image as input*/
public class LocalImageInput {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/aws/1/rekognition_detect_text";
