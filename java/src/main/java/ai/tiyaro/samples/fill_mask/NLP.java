package ai.tiyaro.samples.fill_mask;
...
public class NLP {
  ...
  public void infer() throws Exception {
    ...
    // API endpoint
    var url = "https://api.tiyaro.ai/v1/ent/huggingface/1/distilroberta-base";
    // Input
    var inputString = "Our mission is what makes us [MASK].";
