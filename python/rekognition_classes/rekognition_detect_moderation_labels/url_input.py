...
"""
Sample code to run safe search detection with image url as input
"""
...
def infer():
    ...
    # API endpoint
    url = "https://api.tiyaro.ai/v1/ent/aws/1/rekognition_detect_moderation_labels"

    # Input image
    imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/marathon.jpg"
