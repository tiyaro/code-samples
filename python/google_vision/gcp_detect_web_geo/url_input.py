...
"""
Sample code to run google detect web geo with image url as input
"""
...
def infer():
    ...
    # API endpoint
    url = "https://api.tiyaro.ai/v1/ent/gcp/1/gcp_detect_web_geo"

    # Input image
    imgURL = "https://public-model-demo.s3.us-west-2.amazonaws.com/sydney_operahouse.jpg"
