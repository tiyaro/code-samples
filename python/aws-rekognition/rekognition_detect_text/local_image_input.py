...
"""
Sample code to run text detection with local image as input
"""
...
def infer():
    ...
    # API endpoint
    url = "https://api.tiyaro.ai/v1/ent/aws/1/rekognition_detect_text"

    # Convert binary image to base64
    imgPath = "../../../testdata/ford_slogan.jpg"
